...
* Mean total number of steps taken per day: **`r sprintf("%.2f", dMean)`**
* Median total number of steps taken per day: **`r dMedian`**
...
* The 5-minute interval, on average across all the days that contains the maximum number of steps: **`r maxStepsInterval`**
...
* Mean total number of steps taken per day: **`r sprintf("%.2f", dMean2)`**
* Median total number of steps taken per day: **`r sprintf("%.2f", dMedian2)`**
